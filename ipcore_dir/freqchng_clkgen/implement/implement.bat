...
xst -ifn xst.scr
move freqchng_clkgen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\freqchng_clkgen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc freqchng_clkgen_exdes.ucf freqchng_clkgen_exdes

echo 'Running map'
map -timing -pr b freqchng_clkgen_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm freqchng_clkgen_exdes -w routed.ncd routed.v
cd ..
